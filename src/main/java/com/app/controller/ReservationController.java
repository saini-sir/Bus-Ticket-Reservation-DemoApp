...
public class ReservationController {
	...
	public ResponseEntity<Reservations> addReservation(@Valid @RequestBody ReservationDTO reservationDTO,@PathVariable String key) throws ReservationException, LoginException, MessagingException {
